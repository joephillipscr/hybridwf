...
const DESCRIPTIONS: Record<RouteKey, Record<Locale, string>> = {
  ...
  standard: {
    en: `The Hybrid Workforce Standard v${STANDARD_VERSION} — eighteen normative clauses that separate a governable work resource from a commercial metaphor.`,
    es: `El Hybrid Workforce Standard v${STANDARD_VERSION} — dieciocho cláusulas normativas que separan un recurso de trabajo gobernable de una metáfora comercial.`,
  },
  definition: {
