...
export const CLAUSES: Clause[] = [
  ...
  },
  {
    ...
    text: {
      ...
      es: 'No todo agente califica como AI Employee. El umbral es la categoría misma: las nueve propiedades de la definición, exhibidas en operación. El test funciona en ambas direcciones: un deployment que exhibe las nueve propiedades en operación es un AI Employee sin importar cómo lo llame la organización, y la carga de demostrar la no-calificación recae en el deployer. Las propiedades son hechos del deployment, no papeleo — un contrato de rol sin escribir es una falla de gobierno, no una salida de la categoría.',
    },
    note: {
