...
export const CONFORMANCE: { title: T; body: T[] } = {
  ...
  body: [
    ...
    },
    {
      ...
      es: 'El texto de la cláusula es la unidad citable; citala por identificador, o sea HWF-44 y no un número de página. Las notas son comentario y pueden cambiar entre versiones sin enmendar el estándar.',
    },
  ],
};
