...
export const LIFECYCLE: Stage[] = [
  ...
  { n: 9, name: { en: 'Develop', es: 'Desarrollar' }, objective: { en: 'Coaching or updates to instructions, knowledge, models and tools.', es: 'Coaching o actualización de instrucciones, conocimiento, modelos y herramientas.' } },
