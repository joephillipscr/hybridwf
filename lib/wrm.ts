...
export const LIFECYCLE: Stage[] = [
  ...
  { n: 2, name: { en: 'Allocate', es: 'Asignar' }, objective: { en: 'Decide Human / Assisted human / Deterministic automation / Artificial.', es: 'Decidir Humano / Humano asistido / Automatización determinista / Artificial.' } },
  ...
  { n: 10, name: { en: 'Reassign', es: 'Reasignar' }, objective: { en: 'Change scope, move between occupant types, revise which functions run with assistance.', es: 'Cambiar scope, mover entre tipos de ocupante, revisar qué funciones se ejecutan con asistencia.' } },
...
export const RULES: T[] = [
  ...
  {
    en: 'A transition between occupant types must remain reversible until stable performance is demonstrated.',
    es: 'Una transición entre tipos de ocupante debe ser reversible hasta demostrar performance estable.',
  },
  {
