...
/** Step zero — the precondition of the playbook (HWF-03). */
export const FORWARD_PRECONDITION: T = {
  en: 'Before step one: the human impact assessment of HWF-03, recorded, with affected workers and their representatives informed and consulted. The playbook transfers the work; the assessment governs what the transfer does to people.',
  es: 'Antes del paso uno: la evaluación de impacto humano de HWF-03, registrada, con los trabajadores afectados y sus representantes informados y consultados. El playbook transfiere el trabajo; la evaluación gobierna lo que la transferencia le hace a la gente.',
};
...
export const FORWARD: Step[] = [
  ...
  { n: 10, name: { en: 'Human reallocation', es: 'Reasignación humana' }, control: { en: 'Move released human capacity toward higher-value work, against the training and reassignment plan recorded in the impact assessment (HWF-03).', es: 'Mover capacidad humana liberada hacia trabajo de mayor valor, contra el plan de capacitación y reasignación registrado en la evaluación de impacto (HWF-03).' } },
