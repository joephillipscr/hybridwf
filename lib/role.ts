...
export const RESPONSIBILITIES: T[] = [
  ...
  { en: 'Guarantee every AI Employee has a Role Contract, manager, KPIs, permissions, limits, audit trail, performance review, and a kill switch exercised on a stated cadence (HWF-11).', es: 'Garantizar que todo AI Employee tenga Role Contract, manager, KPIs, permisos, límites, audit trail, performance review, y un kill switch ejercitado con cadencia declarada (HWF-11).' },
  ...
  { en: 'Stay neutral about resource type within the boundary of HWF-01: the goal is neither “use more AI” nor “protect posts” — it is to optimise the work inside the space that rights, dignity, safety and labour protections leave open.', es: 'Mantener neutralidad respecto al tipo de recurso dentro de la frontera de HWF-01: no tiene como meta «usar más IA» ni «proteger puestos»; tiene como meta optimizar el trabajo dentro del espacio que dejan abierto los derechos, la dignidad, la seguridad y las protecciones laborales.' },
...
export const KPIS: Kpi[] = [
  ...
  { name: 'Human Review Burden by Risk Class', measures: { en: 'Review hours per risk class. Overload in Critical is the signature problem of HWF-02 taking shape.', es: 'Horas de revisión por clase de riesgo. La sobrecarga en Crítico es el problema de la firma de HWF-02 tomando forma.' } },
