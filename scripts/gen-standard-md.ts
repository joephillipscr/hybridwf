...
function llmsTxt(): string {
  return [
    `# ${SITE_NAME}`,
    '',
    `> An open administrative standard for AI Employees: eighteen normative clauses, a nine-property test, the WRM (Work Resource Management) framework, a 120-principle matrix, a maturity model, and the HWFS decision instrument. Published under ${LICENSE.id}. Version ${STANDARD_VERSION}, ${STANDARD_DATE}.`,
    '',
