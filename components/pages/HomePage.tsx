...
const C = {
  ...
  isNot: {
    en: [
      ...
      'A funnel for the author’s platform — which, under HWF-21, can never claim conformance with this standard.',
    ...
    es: [
      ...
      'Un embudo hacia la plataforma del autor — que, bajo HWF-21, no puede jamás reclamar conformidad con este estándar.',
