...
const C = {
  ...
  coversBody: {
    en: 'The twenty-seven clauses, the definition and nine-property test, the WRM framework, the 120-principle matrix, the maturity model, the HWFA dimensions, the Hybrid Workforce Manager role, the transition playbooks and the glossary — in both languages.',
    es: 'Las veintisiete cláusulas, la definición y el test de nueve propiedades, el marco WRM, la matriz de 120 principios, el modelo de madurez, las dimensiones del HWFA, el rol de Gerente de Fuerza Laboral Híbrida, los playbooks de transición y el glosario — en ambos idiomas.',
  },
};
