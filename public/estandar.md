...
*Nota:* El puesto existe antes que su ocupante. Un nombre, un tono y un conjunto de instrucciones describen una personalidad; un rol establece qué resultado debe producirse, con qué autoridad y medido cómo.
...
**La identidad de IA nunca debe utilizarse para engañar a clientes o compañeros sobre su naturaleza de software.**

*Nota:* Darle a un sistema un rol, un nombre y un manager mejora la coordinación. Permitir que una persona crea que habla con un ser humano es otro acto, y este estándar no lo permite.

### HWF-11

**Humanos y AI Employees pueden compartir un grafo operativo manteniendo condición y derechos distintos.**

*Nota:* Un organigrama compartido es una conveniencia administrativa, no una afirmación ontológica. Dignidad, salud, descanso, derechos laborales y pertenencia son propiedades de las personas. Antropomorfismo operativo sin confusión ontológica.
...
8. Mantener neutralidad respecto al tipo de recurso: no tiene como meta «usar más IA» ni «proteger puestos»; tiene como meta optimizar el trabajo.
